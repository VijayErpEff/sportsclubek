...
export const SPORT_PAGES: Record<string, SportPageData> = {
  ...
  badminton: {
    ...
    faqs: [
      ...
      { question: "Do you host badminton events and tournaments?", answer: "Yes — we host in-house badminton events year-round, from free open-house clinics to doubles tournaments across Beginner, Intermediate, and Advanced divisions on our BWF-standard courts. We also help prepare players for external competitions. Check our Offers page or call us for what's coming up next." },
