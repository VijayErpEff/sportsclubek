...
export const WEEKLY_SCHEDULE: DaySchedule[] = [
  {
    ...
    sessions: [
      ...
      { time: "7:00 PM",  endTime: "9:00 PM",  activity: "Badminton Academy",            sport: "badminton", level: "All Levels" },
  ...
  },
  {
    ...
    sessions: [
      ...
      { time: "2:00 PM",  endTime: "4:00 PM",  activity: "Open Badminton Courts",        sport: "open" },
