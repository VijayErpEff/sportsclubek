...
export const ATHLETE_SPOTLIGHTS: AthleteSpotlight[] = [
  {
    ...
    quote: "Coach Joe Vanaskey spotted something in my swing that nobody else saw. Two sessions later, I was hitting line drives. Six months later, I was starting cleanup. This place changed my baseball career.",
    story: "Marcus came to LevelUP after being cut from his school's starting lineup. His confidence was shattered. Coach Joe Vanaskey identified a timing issue in his load within the first session and built a 12-week plan around fixing it. Today, Marcus is an all-conference selection.",
    memberSince: "2026",
  ...
  },
  {
    ...
    quote: "Coach Nabeel's footwork program changed everything. I used to get to shuttles late. Now I'm there first. I won the county championship and I'm training for states.",
    story: "Emily was a recreational player with raw talent but inconsistent movement. Coach Nabeel put her through an 8-week footwork intensive. She went from losing in the first round of local tournaments to winning the Cecil County Junior Championship outright.",
    memberSince: "2026",
