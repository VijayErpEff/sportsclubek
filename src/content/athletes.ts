...
export const ATHLETE_SPOTLIGHTS: AthleteSpotlight[] = [
  ...
  },
  {
    ...
    quote: "Before LevelUP, I was practicing with tennis balls in my backyard. Now I'm training on proper nets with a coach who played first-class cricket. I made the state team 8 months after joining. That doesn't happen by accident.",
    story: "Ananya's family moved from New Jersey and couldn't find a proper cricket facility. She joined LevelUP's academy, trained 3x per week with Coach Sharma, and was selected for the Maryland State U-17 squad — the first player from Cecil County to make the team.",
    memberSince: "2023",
