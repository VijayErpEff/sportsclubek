...
export default function VolleyballPage() {
  return (
    <>
      <SportPageLayout data={data} />

      {/* Smash Cup tournament callout — cross-link for SEO + UX */}
              ...
              <div className="grid md:grid-cols-[1fr_auto] gap-6 items-center relative">
                <div>
                  ...
                  <h2 className="font-display text-2xl md:text-3xl font-bold mb-2 text-balance">
                    LevelUP Smash Cup — register your 6v6 squad
                  </h2>
                  <p className="text-white/80 text-sm md:text-base max-w-2xl">
                    Co-ed Youth (12–17) and Adult (18+) divisions. $200 per team, 6–10 player rosters,
                    cash prizes &amp; trophies. Pool play Saturday, playoffs Sunday.
                  </p>
                </div>
